...
def send_request():
    import requests
    receiving_function_url = 'https://us-central1-grauj-gcp.cloudfunctions.net/function-1'
    ...
    jwt = make_iap_request('https://us-central1-grauj-gcp.cloudfunctions.net/function-1', 'https://us-central1-grauj-gcp.cloudfunctions.net/function-1')
